import { expenses } from "@/data/dashboardData";
  ...
  return (
    <section className="mt-12 rounded-4xl bg-white p-8 shadow-sm">
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <div className="rounded-3xl bg-stone-900 px-8 py-6 text-white">
      ...
      <div className="mt-8 grid gap-4">
        {expenses.map((expense) => (
          <article
            key={expense.id}
            className="flex items-center justify-between rounded-3xl border border-orange-100 bg-orange-50 p-5"
          >
            <div>
